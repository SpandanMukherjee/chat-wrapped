...
def monthly_messages_slide():
    ...
    ax.bar(monthly_counts.index.strftime('%b'), monthly_counts.values, color='skyblue')
...
def emoji_stats_slide():
    ...
    ax.barh(all_counts.index, all_counts.values)
...
def early_bird_slide():
    ...
    ax.barh(sorted_ratio.index, sorted_ratio.values, color='skyblue')
...
def message_length_awards_slide():
    ...
    ax.barh(sender_avg_len.index[::-1], sender_avg_len.values[::-1], color='skyblue')
...
def spam_lord_slide():
    ...
    ax.barh(all_senders.index, all_senders.values, color='skyblue')
...
def emoji_awards_slide():
    ...
    ax.barh(all_series.index, all_series.values, color='skyblue')
